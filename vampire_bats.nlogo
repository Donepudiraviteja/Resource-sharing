...
globals [in-min1 in-min2 in-eff1 in-eff2 sel-eff1 sel-eff2 ini_pop e1 e2 ee s1 s2 seas totenergy totenergy1 totenergy2 epoch n1 n2 cum_pop_size1 cum_pop_size2 avg_pop_size1 avg_pop_size2 ratio_pop_size]
;;; Parameters
...
;;; Individuals methods
to do-sucess
  set s1 200 / (count individual1s)
  set s2 200 / (count individual2s)
;set s1 0.71
;set s2 0.71
end
...
to do-totenergy
  ...
  set avg_pop_size1 cum_pop_size1 / ticks
  set cum_pop_size2 (cum_pop_size2 + (count individual2s))
  set avg_pop_size2 cum_pop_size2 / ticks 
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot totenergy"
